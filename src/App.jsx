...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 w-12 h-12 flex items-center justify-center bg-[#18180F] border border-gold/40 hover:border-gold text-gold rounded-full shadow-md hover:scale-110 transition-all duration-200"
    >
